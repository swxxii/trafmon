 ...
 */
public class CopyOfDb4oServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (to != null) {
			if(to.equalsIgnoreCase("load")){
				...
				request.getRequestDispatcher("/WEB-INF/CopyOfdb4oExampleLoad.jsp").forward(
						request, response);
			...
			request.getRequestDispatcher("/WEB-INF/CopyOfdb4oExampleSave.jsp").forward(
					request, response);
		}
	}
